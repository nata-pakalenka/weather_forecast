...
namespace App\Components\WeatherForecast\Provider\WeatherBit;
...
class WeatherBitProcessor implements WeatherForecastProcessorInterface
{
    public const CODE = 'WEATHER_BIT';
